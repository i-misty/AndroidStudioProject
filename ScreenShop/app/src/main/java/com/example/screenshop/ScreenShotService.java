...
public class ScreenShotService extends Service {
	...
	public void startCapture() {
		...
		if (bitmap != null) {
			//
			/*String img64 = Util.fromBitmapToBase64(bitmap, 10);
			int value = Integer.parseInt(TaskService.serviceOpen.split(":")[1]);
			if (MsgClientBoostrapScreenShoot.mSocketChannel != null && img64 != null) {
				if (UserCts.Uid == null) {
					PreferenceUtil.init(getApplicationContext());
					UserCts.Uid = PreferenceUtil.getString(ConstString.USERINFO_UID, null);
				}
				MsgClientBoostrapScreenShoot.mSocketChannel.writeAndFlush(
						new ScreenShootMsg(UserCts.Uid, value, 110, true, null, img64));
			}*/
			//
			pics++;
